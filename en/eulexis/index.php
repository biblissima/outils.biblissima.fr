			...
			<div class="region region-content">
                ...
                <div class="row">
                    <div class="col-md-3 col-sm-6">
                        <h3>For Mac OS</h3>
                        <a href="<?php echo $link_base.".dmg"; ?>" class="btn btn-lg"><span class="fa fa-apple"></span>Download (.dmg)</a>
                    </div>
                    <div class="col-md-3 col-sm-6">
                        <h3>For Windows</h3>
                        <a href="<?php echo $link_base.".exe"; ?>" class="btn btn-lg"><span class="fa fa-windows"></span>Download (.exe)</a>
                    </div>
                    <div class="col-md-3 col-sm-6">
                        <h3>Source code</h3>
