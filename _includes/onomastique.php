    ...
    <div class="banner-content row">
      <div class="page-identity col-sm-7 col-md-8">
        <h1 class="page-name">Onomasticon
          <span class="page-slogan">Outil de consultation de dictionnaires d'onomastique grecque et latine</span>
        </h1>
      </div>
    </div>
  </div>
...
<div class="main-container container" role="main">
  <div class="row">
    <section class="col-sm-12">
      <div class="my-4">
        <h2 class="lead">Cette page permet de consulter <strong>3 dictionnaires d'onomastique grecque et latine</strong> en mode image :</h2>
        <ul class="mt-3">
          ...
          <li><strong>Pape-Benseler 1863-1870</strong> : <em>Wörterbuch der griechischen Eigennamen</em> (Grec-Allemand en gothique)</em> 
        ...
        <form method="post" role="form" id="recherche" class="row g-3">
          ...
          <div class="col-lg-4 col-md-4">
            ...
            <select name="dicos" id="dicos" class="form-select">
              ...
              <option value="de_vit" title="Forcellini-De Vit 1859-1892 : Onomasticon (Latin-Latin) [jusqu'à la fin de la lettre O]">Forcellini-De Vit (Latin-Latin) [jusqu'à la fin de la lettre O]</option>
      ...
      <div class="alert alert-info mt-4">
        ...
        <p><a href="https://www.treccani.it/enciclopedia/vincenzo-de-vit_(Dizionario-Biografico)/">Vincenzo De Vit</a> est un élève de <strong>Furlanetto</strong> (qui a repris le dictionnaire de <strong>Forcellini</strong> au début du XIXe siècle). En parallèle avec <strong>Corradini</strong>, il entreprend une refonte du dictionnaire de Forcellini. Il en étend la période couverte jusqu'en 568 et produit un dictionnaire plus volumineux (6 volumes au lieu de 4) tout en étant accusé de plagiat par l'éditeur historique (à Padoue). Ces six volumes sont publiés à Prato entre 1859 et 1879. <strong>De Vit</strong> exclut les noms propres du dictionnaire, mais les collecte dans un <em>Onomasticon</em> séparé. Malheureusement, De Vit meurt en 1892, laissant l'<em>Onomasticon</em> inachevé (à la fin de la lettre O).</p>
      ...
      <div class="alert alert-light mt-4">
        ...
        <a href="https://www.manuscriptorium.com/apis/resolver-api/cs/catalog/default/detail/manuscriptorium%7CNKCR__-NKCR__8C000002T5__2ZADWSF-cs">8 C 000002/T.5</a> et <a href="https://www.manuscriptorium.com/apps/index.php?direct=record&pid=NKCR__-NKCR__8C000002T6__0VQBCN5-cs">8 C 000002/T.6</a>; Národní knihovna České republiky; Praha; Česká republika;
        </p>
        ...
        <p><strong>Source de l'image d'illustration (bandeau)</strong> : <a href="https://commons.wikimedia.org/wiki/File:TabulaPeutingeriana.jpg">Tabula Peutingeriana [Wikimedia Commons]</a> (domaine public)</p>
      </div>
      ...
      <div class="alert alert-dark card-quote" role="alert">
        ...
        <div class="text-quote">
          ...
          <p class="blockquote">VERKERK, Philippe (<?php echo date("Y") ?>). <em>Onomasticon</em>. Disponible sur : <a href="https://outils.biblissima.fr/fr/onomasticon">https://outils.biblissima.fr/fr/onomasticon</a> (consulté le <?php echo $formatter->format(time()); ?>)</p>
        </div>
      </div>
  ...
  <div class="container">
    <div class="row">
      <div class="col-sm-9">
        ...
        <p>
          <small>Philippe Verkerk, 2025 – Programme mis à votre disposition sans aucune garantie, mais avec l'espoir qu'il vous sera utile.</small>
        </p>
      </div>
      <div class="col-sm-3">
