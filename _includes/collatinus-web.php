    ...
    <section class="col-sm-12">
      ...
      <div class="alert alert-dark card-quote" role="alert">
        ...
        <div class="text-quote">
          ...
          <p class="blockquote">OUVRARD, Yves, VERKERK, Philippe (<?php echo date("Y") ?>). <em>Collatinus-web</em>. Disponible sur : <a href="https://outils.biblissima.fr/fr/collatinus-web">https://outils.biblissima.fr/fr/collatinus-web</a> (consulté le <?php echo $formatter->format(time()); ?>)</p>
        </div>
      </div>
    </section>
  </div>
