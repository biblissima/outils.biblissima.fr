    ...
    <section class="col-sm-12">
      ...
      <div class="alert alert-dark card-quote" role="alert">
        ...
        <div class="text-quote">
          ...
          <p class="blockquote">VERKERK, Philippe (<?php echo date("Y") ?>). <em>Eulexis-web</em>. Disponible sur : <a href="https://outils.biblissima.fr/fr/eulexis-web">https://outils.biblissima.fr/fr/eulexis-web</a> (consulté le <?php echo $formatter->format(time()); ?>)</p>
        </div>
      </div>
